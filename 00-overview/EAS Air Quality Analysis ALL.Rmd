...
data_file <- "./data/quant_aq/MOD-PM-00545-Montreal.csv"  # Data file path for AQ data
...
met_file <- "data/met/montreal_met.csv"
...
aq_df_met$lat <- 45.392796
aq_df_met$long <- -74.062294
...
polarPlot(aq_df_met, pollutant = "pm10")
